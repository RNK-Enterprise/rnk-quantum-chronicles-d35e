...
export class TreasureGeneratorDialog extends FormApplication {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "systems/rnk-quantum-d35e/templates/apps/treasure-generator-dialog.html",
      width: "auto",
      height: "auto",
      closeOnSubmit: false,
      submitOnClose: false,
  ...
  async genTreasure() {
    ...
    let createdItems = await actor.createEmbeddedEntity("Item", itemsToCreate, { stopUpdates: true });

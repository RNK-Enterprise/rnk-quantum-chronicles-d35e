export class LevelUpDataDialog extends FormApplication {
    constructor(...args) {
        super(...args);
        //console.log('D35E | Level Up Windows data', this.object)
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            ...
            title: "Level Data",
            template: "systems/rnk-quantum-d35e/templates/apps/level-up-data.html",
            width: 840,
            height: "auto",
            closeOnSubmit: false,
            submitOnClose: false,
    ...
    getData() {
        ...
        let data = {
            actor: this.actor,
            classes: classes,
            classesJson: JSON.stringify(classes.map(_c => { return {id: _c._id, classSkills: _c.system.classSkills}})),

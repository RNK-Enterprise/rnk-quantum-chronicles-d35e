...
const ApplicationV2Class = HandlebarsApplicationMixin ? HandlebarsApplicationMixin(ApplicationV2) : ApplicationV2;

export class CraftingStation extends ApplicationV2Class {
  constructor(...args) {
    super(...args);
  ...
  static get DEFAULT_OPTIONS() {
    return {
      id: "crafting-station",
      classes: ["crafting-station-window"],
      window: {
  ...
  static PARTS = {
    content: {
      template: "systems/rnk-quantum-d35e/templates/apps/crafting-station.html"
    }
  };

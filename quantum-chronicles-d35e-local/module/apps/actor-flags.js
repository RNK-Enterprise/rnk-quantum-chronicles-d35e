...
const DocumentSheetClass =
  foundry?.applications?.v1?.DocumentSheet ??
  foundry?.appv1?.sheets?.DocumentSheet ??
  globalThis?.DocumentSheet;

export class ActorSheetFlags extends DocumentSheetClass {
  static get defaultOptions() {
    const options = super.defaultOptions;
    return foundry.utils.mergeObject(options, {
      id: "actor-flags",
      classes: ["D35E"],
      template: "systems/rnk-quantum-d35e/templates/apps/actor-flags.html",
      width: 500,
      closeOnSubmit: true
    });
  }
  ...
  _getFlags() {
    ...
    for ( let [k, v] of Object.entries(CONFIG.D35E.characterFlags) ) {
      ...
      flag.value = this.object.getFlag(SYSTEM_ID, k);
